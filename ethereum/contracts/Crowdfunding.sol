...
contract Crowdfunding {
    ...
    function createCampaign(
        ...
        require(_goal > 0, "Obiectivul trebuie sa fie pozitiv");
    ...
    function withdraw(uint256 _id) external campaignExists(_id) onlyOwner(_id) {
        Campaign storage campaign = campaigns[_id];
        require(campaign.amountRaised >= campaign.goal, "Obiectivul nu a fost atins");
        require(campaign.isActive, "Campania nu este activa");
    ...
    function refund(uint256 _id) external campaignExists(_id) {
        ...
        require(campaign.amountRaised < campaign.goal, "Obiectivul a fost atins");
